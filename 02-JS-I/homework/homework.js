...
function esVocal(letra){
  ...
  //Escribe tu código aquí:
  if (letra == "A" || letra == "E" || letra == "I" || letra == "O" || letra == "U" || letra == "a" || letra == "e" || letra == "i" || letra == "o" || letra == "u"){console.log("es vocal");}
  else if (letra.lenght !==1){console.log("Dato incorrecto")}
